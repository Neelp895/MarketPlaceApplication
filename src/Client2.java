...
/**
 * The market interface that shows buyers and sellers info about the market,
...
public class Client2 {
    ...
    public Client2(ArrayList<Product> products) {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (!hostPort.contains(" ")) {
                JOptionPane.showMessageDialog(null,
                        "Please enter the two values separated with one space!", "Port Info",
        ...
        try {
            ...
            if (want.equals("Buyer")) {
                ...
                //System.out.println(market.toString(market.getProducts().get(i).getStore(),
                //      market.getProducts().get(i).getProduct(),
                //    market.getProducts().get(i).getPrice()));
                //}
                    ...
                    if (want.equals("None")) {
                        ...
                        if (want1.equals("Buy Product")) {
                            ...
                            if (buyWant.equals("Buy Now")) {
                                ...
                                //System.out.println(market.toString(market.getProducts().get(
                                //              productNumber).getStore(),
                                //    market.getProducts().get(productNumber).getProduct(),
                                //  market.getProducts().get(productNumber).getPrice()));
                                if (market.getProducts().get(productNumber).getQuantity() <= 0) {
                                    ...
                                    do {
                                        ...
                                        try {
                                            ...
                                            JOptionPane.showMessageDialog(null,
                                                    "Invalid Input! Please enter a Number!", "Buyer Interface",
                                                    JOptionPane.PLAIN_MESSAGE);
                                            invalid = 1;
                                        }
                                    ...
                                    if (quantityBought > 0) {
                                        ...
                                        //System.out.println(market.getProducts().get(productNumber));
                            ...
                            //    add item (productNumber) to shopping cart
                            //}
                        ...
                        if (want1.equals("Sort Products by Price")) {
                            System.out.println("trying to sort by price");
                            //trying to sort market by price
                            int n = market.getProducts().size();
                            Product placeHolder = null;
                            for (int i = 0; i < n - 1; i++) {
                        ...
                        if (want1.equals("Sort Products by Quantity")) {
                            System.out.println("trying to sort by quantity");
                            //trying to sort market by quantity
                            int n = market.getProducts().size();
                            Product placeHolder = null;
                            for (int i = 0; i < n - 1; i++) {
                        ...
                        if (sellerWant.equals("Add new Product")) {
                            ...
                            if (importWant.equals("Manually")) {
                                ...
                                if (newWant == 0) {
                                    ...
                                    System.out.println("Flushing list");

                                    System.out.println("SellerList size " + sellerList.size());

                                    for (int i = 0; i < sellerList.size(); i++) {

                                        System.out.println(sellerList.get(i).getProduct());
                            ...
                            if (importWant.equals("File Import")) {
                                ...
                                if (importCheck) {
                                    System.out.println("Reached import check");
                        ...
                        if (sellerWant.equals("Edit existing Product")) {
                            ...
                            if (!editProduct.equals("None")) {
                                ...
                                if (newWant == 0) {
                                    ...
                                    System.out.println(sellerList.get(editProduct1).getProduct());
                                    ...
                                    // test print vv
                                    //for (int i = 0; i < market.getProducts().size(); i++) {
                                    //    System.out.println(market.getProducts().get(i).getProduct());
                                    //}
